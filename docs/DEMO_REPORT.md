...
<iframe src="../assets/reports/comparison_report.pdf" width="100%" height="800px">
    <p>Your browser does not support iframes. <a href="assets/reports/comparison_report.pdf">Download the PDF</a> to view it.</p>
</iframe>

[Download Report](assets/reports/comparison_report.pdf){ .md-button .md-button--primary }
